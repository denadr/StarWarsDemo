...
var FilmsService = (function (_super) {
    __extends(FilmsService, _super);
    function FilmsService(_http) {
        var _this = _super.call(this, _http) || this;
        _this._http = _http;
        return _this;
    }
    FilmsService.prototype.get = function () {
        return _super.prototype.getFrom.call(this, 'films/');
    };
    return FilmsService;
...
//# sourceMappingURL=FilmsService.js.map