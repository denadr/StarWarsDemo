...
var PlanetsService = (function (_super) {
    __extends(PlanetsService, _super);
    function PlanetsService(_http) {
        var _this = _super.call(this, _http) || this;
        _this._http = _http;
        return _this;
    }
    PlanetsService.prototype.get = function () {
        return _super.prototype.getFrom.call(this, 'planets/');
    };
...
//# sourceMappingURL=PlanetsService.js.map