...
var SpeciesService = (function (_super) {
    __extends(SpeciesService, _super);
    function SpeciesService(_http) {
        var _this = _super.call(this, _http) || this;
        _this._http = _http;
        return _this;
    }
    SpeciesService.prototype.get = function () {
        return _super.prototype.getFrom.call(this, 'species/');
    };
