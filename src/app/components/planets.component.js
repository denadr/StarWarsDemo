...
var PlanetsComponent = (function () {
    function PlanetsComponent(_service) {
        this._service = _service;
    }
    PlanetsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._service.get().subscribe(function (planets) { return _this.planets = planets; });
    };
...
PlanetsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [PlanetsService_1.PlanetsService])
], PlanetsComponent);
