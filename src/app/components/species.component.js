...
var SpeciesComponent = (function () {
    function SpeciesComponent(_service) {
        this._service = _service;
    }
    SpeciesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._service.get().subscribe(function (species) { return _this.species = species; });
    };
...
SpeciesComponent = __decorate([
    ...
    __metadata("design:paramtypes", [SpeciesService_1.SpeciesService])
], SpeciesComponent);
